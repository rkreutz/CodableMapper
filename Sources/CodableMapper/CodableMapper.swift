...
public extension KeyedDecodingContainer {
    ...
    func decode<Provider, Value>(_ type: CodableMapper<Provider>.Type, forKey key: Key) throws -> CodableMapper<Provider> where Provider.Value == Optional<Value> {
...
public extension KeyedEncodingContainer {
    ...
    mutating func encode<Provider, Value>(_ value: CodableMapper<Provider>, forKey key: Key) throws where Provider.Value == Optional<Value> {
